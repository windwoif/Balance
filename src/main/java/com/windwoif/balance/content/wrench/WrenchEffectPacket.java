...
public class WrenchEffectPacket extends SimplePacketBase {

    private BlockPos pos;
    private Direction direction;
    private boolean fullBlock;

    public WrenchEffectPacket(BlockPos pos, Direction direction, boolean fullBlock) {
        this.pos = pos;
        this.direction = direction;
        this.fullBlock = fullBlock;
    }

    public WrenchEffectPacket(FriendlyByteBuf buffer) {
    ...
    public void handleClient() {
        ...
        if (!mc.player.blockPosition().closerThan(pos, 100))
            return;
        WrenchItem.spawnParticles(mc.level, pos, direction, fullBlock);
    }
